...
@role('Teacher|Admin')
 <li class="relative px-6 py-3 mt-4">
    <a href="{{ route('teacher.dashboard') }}" class="font-semibold text-gray-500 uppercase text-xs tracking-wider hover:text-gray-700 dark:hover:text-gray-300">Teacher Portal</a>
</li>
 <li class="relative px-6 py-3">
...
<li class="relative px-6 py-3">
        <x-nav-link :href="route('teacher.cbt.index')" :active="request()->routeIs('teacher.cbt.*')">
...
@endrole
            ...
            <li class="relative px-6 py-3">
                <x-nav-link :href="route('student.results.index')" :active="request()->routeIs('student.results.*')">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    <span class="ml-4">My Results</span>
                </x-nav-link>
            </li>
            <li class="relative px-6 py-3">
            ...
            <li class="relative px-6 py-3">
        <x-nav-link :href="route('student.cbt.index')" :active="request()->routeIs('student.cbt.*')">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
            <span class="ml-4">CBT Exams</span>
        </x-nav-link>
    </li>
            @endrole
